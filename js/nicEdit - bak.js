...
var nicUploadButton=nicEditorAdvancedButton.extend({
    ...
    startUpload:function(){
        ...
        this.myStatus.setContent('<img src="http://files.nicedit.com/ajax-loader.gif" style="float: right; margin-right: 40px;" /><strong>Загружаем...</strong><br />Пожалуйста подождите');
        this.myForm.submit();
